...
export default function AddBookForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="mb-4">
        <label htmlFor="coverUrl" className="flex items-center justify-between">
          <span className="text-gray-700 font-medium mb-2">URL da Capa (opcional)</span>
          <span className="text-xs text-amber-600">Não recomendado: problemas de direitos autorais</span>
        </label>
        <input
          type="url"
          id="coverUrl"
          ...
          onChange={handleChange}
          placeholder="Deixe em branco para usar capas geradas automaticamente"
        ...
        />
        <p className="mt-1 text-xs text-gray-500">O uso de capas geradas é recomendado para evitar problemas legais de direitos autorais.</p>
      </div>
